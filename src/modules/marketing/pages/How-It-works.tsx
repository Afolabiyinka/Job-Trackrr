...
const steps = [
  {
    ...
    description:
      "Sign up in seconds and set up your job search profile. No credit card required.",
    icon: User,
  },
  {
    step: "02",
    ...
    description:
      "Add and organize every job you apply to in one place. Drag and drop between stages.",
    icon: Search,
  },
  {
    step: "03",
    ...
    description:
      "Get insights on your job search performance and improve faster with AI-powered suggestions.",
    icon: ChartBar,
  },
];
