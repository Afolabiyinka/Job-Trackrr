  ...
  return (
    <div className="min-h-screen rounded-lg p-2 md:p-10 w-full text-center flex justify-center items-center flex-col">
      <motion.h1
        ...
        className="text-2xl md:text-6xl font-bold mb-2 text-center leading-snug font-heading"
      >
        ...
        >
          {reviews.map((review, index) => (
            <SwiperSlide key={index} className="w-auto">
              <div className="h-full p-6 md:p-6  bg-muted rounded-xl flex flex-col justify-between items-center gap-4">
