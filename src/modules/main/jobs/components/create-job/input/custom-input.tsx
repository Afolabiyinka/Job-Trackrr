...
const CustomInput = ({
  ...
  return (
    <div>
      <div
        className={`flex items-center h-14 w-full overflow-hidden rounded-full px-5 gap-2 border border-primary/50 focus-within:ring-2 focus-within:ring-muted/50 transition ${className ?? ""}`}
      >
