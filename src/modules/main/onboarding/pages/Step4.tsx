...
const Step4 = () => {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault()
        await handleOnboard({
            linkedinUrl, preferredRole, skills
        })
    }
        ...
        >
            ...
            <form onSubmit={handleSubmit}>
                <div className="space-y-1.5">
                    ...
                    >
                        Add your top skills so we can match you with the right opportunities.
                    </motion.p>
                </div>
                ...
                >
                    ...
                    <p className="text-xs text-muted-foreground pl-0.5">
                        Press <kbd className="px-1 py-0.5 rounded bg-muted text-muted-foreground text-xs font-mono">Enter</kbd> or click Add to insert a skill.
                    </p>
                </motion.div>
